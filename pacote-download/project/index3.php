...
//                                                    echo $dados;
                            ...
                            <!-- col -->
                                <div class=" col-lg-8">
                                    <div class="card">
                                        <div class="card-body">
                                                <h1>Lista de Nome e de Usuario</h1>
                                                <h4>
                                                    <?php
                                               ...
                                               $result_usuarios = " SELECT DISTINCT A.NOME, K_IP_EO_CONTRATO.USUARIOINCLUIU FROM Z_GRUPOUSUARIOS A (NOLOCK)
                                                                    INNER JOIN K_IP_EO_CONTRATO K_IP_EO_CONTRATO (NOLOCK)
                                                                    ON (K_IP_EO_CONTRATO.USUARIOINCLUIU = A.HANDLE)
                                                ...
                                                while($rows_usuario = sqlsrv_fetch_array($resultado_usuarios,SQLSRV_FETCH_ASSOC)){
                                                       // echo "Empresa: " . $rows_usuario['EMPRESA'] . "<br>";
                                                        echo "Nome: " . $rows_usuario['NOME'] . "<br>";
                                                        echo "Usuario: " . $rows_usuario['USUARIOINCLUIU'] . "<br><hr>";
