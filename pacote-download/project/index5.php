                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="lista.php">Listar SO</a></li
                                <li><a href="index2.php">NomeCli_numCli</a></li>
                                ...
                                <div class=" col-lg-8">
                                    <div class="card">
                                        <div class="card-body">
                                               ...
                                               $result_usuarios = " SELECT GN_PESSOAS.NOME CLIENTE,
                                                                        K_IP_CONTRATOS.CONTRATO SERVICOS,
                                                                        E.DESCRICAO DESCRICAO_SERVICOS,
                                                                        CONVERT( VARCHAR(250),E.DATAENVIO)DATAENVIO,
                                                                        E.CORPO
                                                                    FROM K_IP_EO_ENVIO E (NOLOCK)
                                                                        INNER JOIN K_IP_CONTRATOS K_IP_CONTRATOS (NOLOCK) ON (E.CONTRATO = K_IP_CONTRATOS.HANDLE)
                                                                        INNER JOIN GN_PESSOAS GN_PESSOAS (NOLOCK) ON (K_IP_CONTRATOS.CLIENTE = GN_PESSOAS.HANDLE)
                                                                        ";
                                                ...
                                                while($rows_usuario = sqlsrv_fetch_array($resultado_usuarios,SQLSRV_FETCH_ASSOC)){
                                                       // echo "Empresa: " . $rows_usuario['EMPRESA'] . "<br>";
                                                        echo "Nome_Cliente: " . utf8_encode($rows_usuario['CLIENTE']) . "<br>";
                                                        echo "Contrato_Servicos: " . utf8_encode($rows_usuario['SERVICOS']) . "<br>";
                                                        echo "Descricao_Servicos: " . utf8_encode($rows_usuario['DESCRICAO_SERVICOS']) . "<br>";
                                                        echo "Data_Envio: " . $rows_usuario['DATAENVIO'] . "<br>";
                                                        echo "Corpo_Email: " . utf8_encode($rows_usuario['CORPO']) . "<br><hr>";
